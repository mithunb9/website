        ...
        <div id="about" class="mt-2 text-sm">
          ...
          <div class="text-sm">
            <p class="mt-2">
              ...
              development, artificial intelligence, and technology consulting.
            </p>
            <p class="mt-2">
              I am committed to achieving academic excellence while developing
              practical experience through internships and extracurricular
              projects.
            </p>
            <p class="mt-2">
              With a strong foundation in computer science principles and a deep
              interest in emerging technologies, I am excited to contribute to
              innovative and impactful projects and to continue growing as a
              professional.
            </p>
          </div>
        </div>
        <div id="social" class="flex space-x-2">
          ...
          <a href="https://github.com/mithunb9" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="2rem"
              viewBox="0 0 496 512"
